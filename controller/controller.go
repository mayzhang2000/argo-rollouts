...
func NewManager(
	...
	notificationsController := notificationcontroller.NewControllerWithMultipleNamespace(dynamicclientset.Resource(v1alpha1.RolloutGVR), rolloutsInformer.Informer(), apiFactory,
